...
ARG GO_ENV_PACKAGE_NAME=github.com/bridgewwater/drone-plugin-temple
ARG GO_ENV_ROOT_BUILD_BIN_NAME=drone-plugin-temple
ARG GO_ENV_ROOT_BUILD_BIN_PATH=build/${GO_ENV_ROOT_BUILD_BIN_NAME}
ARG GO_ENV_ROOT_BUILD_ENTRANCE=cmd/drone-plugin-temple/main.go
